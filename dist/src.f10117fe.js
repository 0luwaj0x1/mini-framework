...
function () {
  ...
  Sync.prototype.fetch = function (id) {
    return axios_1.default.get(this.baseUrl + "/" + id);
  };
  ...
  Sync.prototype.save = function (data) {
    ...
    if (id) {
      return axios_1.default.put(this.baseUrl + "/" + id, data);
    } else {
...
},{"./models/User":"src/models/User.ts"}],"../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
